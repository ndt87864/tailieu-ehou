...
const CalendarReminder = () => {
  ...
  const todayHasImportantNotes = () => {
    ...
    return calendarNotes.some((note) => {
      ...
      if (
        ...
        dateMatches =
          formatDateForComparison(new Date(noteDate)) === formattedToday;
      }
  ...
  const dayHasImportantNotes = (day) => {
    ...
    return calendarNotes.some((note) => {
      ...
      if (
        ...
        // Nếu noteDate là timestamp hoặc Date, chuyển đổi sang chuỗi
        dateMatches =
          formatDateForComparison(new Date(noteDate)) === formattedCheckDate;
      }
  ...
  return (
    <div
      className={`fixed right-4 bottom-24 z-40 rounded-lg shadow-lg ${
        isDarkMode
                ...
                .map((note) => (
                  ...
                  >
                    ...
                    <div className="font-medium flex items-center justify-between">
                      ...
                      {note.important && (
                        <span className="text-xs px-1.5 py-0.5 text-red-800 rounded-sm">
                          [ Quan trọng]
                        </span>
                      )}
                    </div>
            ...
            <div className="mt-2 space-y-2 max-h-32 overflow-y-auto">
              {calendarNotes
                .filter((note) => {
                  ...
                  // Nếu noteDate là timestamp hoặc Date, chuyển đổi sang chuỗi
                  return (
                    formatDateForComparison(new Date(noteDate)) ===
