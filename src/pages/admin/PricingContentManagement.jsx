...
const PricingContentManagement = () => {
  ...
  const renderPreview = () => {
    ...
    return (
      <div className={`mt-4 p-3 rounded-lg border ${isDarkMode ? 'bg-gray-700 border-gray-600' : 'bg-gray-50 border-gray-200'}`}>
          ...
          <main className={`p-4 md:p-6 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-slate-100 text-gray-900'}`}>
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
                <div>
                  <h1 className="text-2xl font-bold mb-2">Quản lý nội dung liên hệ</h1>
              ...
              {/* Content List */}
              <div className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-lg shadow-lg border overflow-hidden`}>
                ...
                <div className="p-6">
                  {content.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <p className="mt-2 text-gray-500">Chưa có nội dung nào được tạo.</p>
                    </div>
                  ) : (
                                ...
                                {item.links && item.links.length > 0 && (
                                  <div className="mt-2 space-y-1">
                                    ...
                                    {item.links.map((link, index) => (
                                      <div key={index} className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className={`inline-block align-bottom rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full ${
              ...
              {/* Modal Header */}
              <div className={`px-6 py-4 border-b ${isDarkMode ? 'bg-gray-700/50 border-gray-700' : 'bg-gray-50 border-gray-200'}`}>
              ...
              {/* Modal Body */}
              <div className={`px-6 py-5 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    {formData.links.map((link, index) => (
                      <div key={index} className="mb-3 p-3 border rounded-md bg-gray-50 dark:bg-gray-700/30">
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-sm font-medium">Liên kết {index + 1}</span>
                          <button
                            type="button"
              ...
              {/* Modal Footer */}
              <div className={`px-6 py-4 sm:flex sm:flex-row-reverse ${isDarkMode ? 'bg-gray-700/30 border-t border-gray-700' : 'bg-gray-50 border-t border-gray-200'}`}>
                <button
                  type="button"
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-500'}`}>
                        Bạn có chắc chắn muốn xóa mục này? Hành động này không thể khôi phục.
                      </p>
