              ...
              <li key={index}>
                <NavLink
                  ...
                  className={({ isActive }) => `
                    ...
                    ${isActive 
                      ? (isDarkMode ? 'bg-gray-700 text-white' : 'bg-purple-700 text-white')
                      : (isDarkMode ? 'text-gray-300 hover:bg-gray-700 hover:text-white' : 'text-white hover:bg-purple-800 hover:text-white')
                    }
                  `}
                >
