...
const FooterManagement = () => {
  ...
  const handleAddFooter = async (e) => {
    ...
    if (
      newFooter.content.length === 0 ||
      !newFooter.content.some((item) => item.trim())
    ) {
  ...
  const handleEditFooter = async (e) => {
    ...
    if (
      editFooter.content.length === 0 ||
      !editFooter.content.some((item) => item.trim())
    ) {
      setFormError("Vui lòng nhập ít nhất một nội dung");
      return;
    }
  ...
  const handleDeleteFooter = async () => {
    ...
    try {
      setIsSubmitting(true);
      const updatedSections = footerSections.filter(
        (section) => section.id !== footerToDelete.id
      );
      const updatedFooter = { sections: updatedSections };
                ...
                <form onSubmit={handleAddFooter}>
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setNewFooter({ ...newFooter, title: e.target.value })
                      }
                    />
                  </div>
                      ...
                      {newFooter.content.map((item, index) => (
                        ...
                        >
                          <textarea
                            ...
                            value={item}
                            onChange={(e) =>
                              updateContentItem(index, e.target.value, false)
                            }
                ...
                <form onSubmit={handleEditFooter}>
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditFooter({ ...editFooter, title: e.target.value })
                      }
                    />
                  </div>
                      ...
                      {editFooter.content.map((item, index) => (
                        ...
                        >
                          <textarea
                            ...
                            value={item}
                            onChange={(e) =>
                              updateContentItem(index, e.target.value, true)
                            }
                            className={`flex-1 rounded py-2 px-3 ${
                              isDarkMode
                                ? "bg-gray-700 text-white border-gray-600"
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-3">
                      <p className="text-base">
                        Bạn có chắc chắn muốn xóa footer "
                        {footerToDelete?.title}"? Hành động này không thể khôi
                        phục.
                      </p>
                    </div>
                  </div>
